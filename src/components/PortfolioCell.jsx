...
function PortfolioCell() {
    const imageList = [
        ...
        { src: 'ProjectThumbnail/jrgb.png', headText: '종합설계프로젝트 - 유저 파라미터 3D 악세사리 출력 서비스',
            ...
            <PortfolioList>
                {imageList.map((image, index) => (
                    <PortfolioItem key={index}>
                        <PortfolioCellSRC portfolioData={image} />
                    </PortfolioItem>
                ))}
            </PortfolioList>
        </PortfolioListContainer>
