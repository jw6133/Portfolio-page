        ...
        <>
            <Footer>
                <div className='btnWrapper'>
                    ...
                    <button className='git-btn linkBtn' onClick={() => window.open("https://github.com/jw6133")}><SiGithub /></button>
                    <span className='btn-title insta-title'>Instagram Link : </span>
                    <button className='insta-btn linkBtn' onClick={() => window.open("https://www.instagram.com/baack_g/")}><FaInstagram /></button>
                </div>
            </Footer>
        </>
    );
